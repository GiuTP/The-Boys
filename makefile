...
HDR = entidades.h conjunto.h fila.h fprio.h eventos.h

# lista de arquivos-objeto (a completar)
# não inclua conjunto.o, senão ele será removido com "make clean"
OBJ = theboys.o fila.o fprio.o eventos.o entidades.o
...
eventos.o: eventos.c eventos.h fila.h fprio.h conjunto.h entidades.h
